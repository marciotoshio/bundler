  ...
  describe "with --path" do
    ...
    context "with path_relative_to_cwd set to true" do
      ...
      it "installs the standalone bundle relative to the cwd" do
        bundle! :install, :gemfile => bundled_app("Gemfile"), :standalone => true, :dir => bundled_app.parent
        ...
        bundle! :install, :gemfile => bundled_app("Gemfile"), :standalone => true, :dir => bundled_app("subdir").tap(&:mkpath)
